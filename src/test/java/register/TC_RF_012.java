...
public class TC_RF_012 {
	...
	public void verifyRegisteringAccountUsingKeyboardKeys() {
		...
		actions.sendKeys("Brajesh").sendKeys(Keys.TAB).sendKeys("Singh").sendKeys(Keys.TAB).sendKeys(Utility.GenerateNewEmailAddressWithTimeStamp())
		.sendKeys(Keys.TAB).sendKeys("1234567890").sendKeys(Keys.TAB).sendKeys("12345").sendKeys(Keys.TAB)
		.sendKeys("12345").sendKeys(Keys.TAB).sendKeys(Keys.ARROW_LEFT).sendKeys(Keys.TAB).sendKeys(Keys.TAB)
